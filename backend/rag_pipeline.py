...
from chunking import chunk_by_lines, get_chunk_metadata
from config import (
...
class RAGPipeline:
    ...
    def build_database(
        ...
        Example:
            ...
            >>> success = pipeline.build_database("fastapi", "fastapi")
    ...
    def search(
        ...
        Args:
            ...
            include_distances (bool): Include similarity distances
            
        Returns:
            dict: Search results with code, metadata, and scores
            
        Example:
            >>> results = pipeline.search("How to handle errors?")
        ...
        try:
            ...
            for i, chunk_id in enumerate(raw_results["ids"][0]):
                ...
                # Add similarity score if distances provided
